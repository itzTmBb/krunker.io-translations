...
settings.chat.chatBGOp Opacidad del fondo del chat
...
settings.interface.spectators Mostrar el contador de espectadores
settings.interface.speed Mostrar velocidad de movimiento
settings.interface.speedOffX Ubicación de velocidad en X
settings.interface.speedOffY Ubicación de velocidad en Y
settings.interface.speedOpacity Opacidad de velocidad
settings.interface.speedScale Escala de velocidad
settings.interface.speedColor Color de velocidad (Actual)
settings.interface.speedColorMax Color de velocidad (Máxima)
settings.interface.medals Mostrar medallas
...
settings.crosshair.style.1 Círculo vacío
settings.crosshair.style.2 Círculo sólido
settings.crosshair.style.3 Cuadrado vacío
...
settings.hitmarker.thickness Grosor
settings.hitmarker.opacity Opacidad
settings.hitmarker.leng Longitud
settings.hitmarker.spacing Separación
settings.hitmarker.animD Tamaño de animación
settings.hitmarker.animS Velocidad de animación
settings.hitmarker.hitm Mostrar
settings.hitmarker.hitmFad Velocidad de desvanecimiento
settings.hitmarker.custom Imagen de hitmarker
settings.hitmarker.custom.paste URL de imagen del hitmarker
settings.onKillS.style.0 Predeterminado
...
settings.mods.streak.paste URL de imagen de rachas de bajas
settings.mods.timer Icono de temporizador
settings.mods.timer.paste URL de imagen de temporizador
settings.mods.usedamage Usar capa de daño
settings.mods.damage Imagen de capa de daño
...
windows.loadout.back Accesorios de Cuerpo
...
windows.mods.guide Guía de mods
windows.mods.list Lista de mods
windows.mods.load.header Cargar mod
windows.mods.publish Publicar mod
windows.mods.viewer Inspeccionar
windows.account.header Cuenta
windows.account.recover Para recuperar tu cuenta contacta a <a>recovery@yendis.ch</a>
windows.class.header Seleccionar clase
windows.controls.header Cambiar controles
windows.controls.forward Adelante
windows.controls.backward Atrás
...
windows.host.raw Archivos de mapa
...
windows.maps.editor Editor de mapa
windows.maps.publish Publicar mapa
windows.maps.community Comunidad de creadores de mapas
windows.publish.map.header Publicar o actualizar mapa,
windows.publish.map.thumbnail Sin miniatura
windows.publish.map.paste Pegar datos del mapa
windows.publish.map.update Publicar/actualizar
windows.publish.map.login para crear y subir mapas!
windows.theatre.header Modo teatro
windows.theatre.record Activar grabación
windows.theatre.key Tecla de grabación
windows.clans.header Clanes
windows.clans.members Miembros ({0})
windows.clans.requests Peticiones
windows.clans.requests.none Sin peticiones
windows.clans.page [{0}] Página del clan
...
windows.waist.header Seleccione accesorio de cintura
...
windows.mods.community.new Nuevos mods
windows.mods.community.hot Mods populares
windows.mods.community.name Nombres de mods
windows.mods.community.none No se encontró mods
windows.publish.mod.header Publicar mod
windows.publish.mod.thumbnail Sin miniatura
windows.publish.mod.name Nombre de mod
windows.publish.mod.paste URL de mod
...
windows.ranked.mode.r4v4 Escuadrón
...
error.seek Prueba buscando una nueva partida haciendo click
custom.map.upload.limit Error. Límite de 500k caracteres en los datos del mapa alcanzados
custom.map.missing Selecciona un tipo de juego o mapa
custom.mode.missing Selecciona un modo de juego
custom.class.missing Selecciona una clase
server.config.maxPlayers Jugadores máximos
server.config.minPlayers Jugadores mínimos
...
server.config.wallJP Intensidad de salto en paredes
...
social.login.sell Inicia sesión para vender
social.login.gift Inicia sesión para regalar
social.login.proccessing Iniciando sesión...
social.since Desde
social.user.maps Mapas del usuario
social.user.mods Mods del usuario
social.maps.none No se encontraron mapas...
social.mods.none No se encontraron mods...
social.market.price.low Precio más bajo
social.market.price.list Listar precio en
social.market.searching Buscando
social.market.listed Listado hace {0}
social.market.list Listar objeto
social.market.unlist Deslistar
